...
const tools: Tool[] = [
  ...
  {
    id: 2, name: "Claude", category: "AI Assistant", description: "Anthropic's thoughtful AI assistant excelling at long-form analysis, coding, and nuanced conversations with strong safety alignment.", pricing: "Freemium", featured: true, color: "linear-gradient(135deg, hsl(25 60% 18%), hsl(35 50% 24%))", initial: "CL",
  },
  {
